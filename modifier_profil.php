...
.phone{width:100%;max-width:380px;background:#f0f0f0;min-height:100vh;padding-bottom:60px}
...
.btn-save{width:100%;background:#31589f;color:white;border:none;border-radius:25px;padding:14px;font-size:16px;font-weight:bold;cursor:pointer;margin-top:10px}
</style>
</head>
<body>
<div class="phone">
...
<span class="titre">Modifier mon profil</span>
</div>
<div class="content">
<form method="post" class="card">
<div class="input-group">
<label>Nom complet</label>
<input type="text" name="nom" value="ALPHA DIALLO" required>
</div>
<div class="input-group">
<label>Email</label>
<input type="email" name="email" value="alpha.diallo@unchk.edu.sn" required>
</div>
<div class="input-group">
<label>Téléphone</label>
<input type="tel" name="tel" value="+221 77 123 45 67" required>
</div>
